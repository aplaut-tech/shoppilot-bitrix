<?
$events = GetModuleEvents("shoppilot.client", "OnModuleUnInstall");
...
{
	echo CAdminMessage::ShowMessage(GetMessage("SHOPPILOT_CLIENT_UNINSTALL_IMPOSSIBLE")."<br />".$ex->GetString());
	?>
...
else
{
	...
	<?=bitrix_sessid_post()?>
		...
		<input type="hidden" name="id" value="shoppilot.client">
