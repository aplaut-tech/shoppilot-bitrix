...
Class shoppilot_reviews extends CModule {
	...
	function shoppilot_reviews() //Конструктор класса модуля
	{
	...
	function DoInstall()
	{
		...
		if( !in_array('curl', get_loaded_extensions()) ) {
			$APPLICATION->ThrowException( GetMessage("SHOPPILOT_REVIEWS_CURL_ERR") );
			return false;
		}
	...
	function InstallDB()
	{
		...
		COption::SetOptionString("shoppilot.reviews", "shoppilot_api_endpoint", "https://shoppilot.ru/api/v1/orders");
